...
module.exports = function () {
    program.version("1.0.8").option("-c --color <color>", "Color of sprite icons").option("-d --directory <directory>", "SVG folder").option("-e --excel <csv>", "CSV file path").option("-l --list <list>", "List of files").option("-o --output <output>", "Out put to file").option("-s --sprite <sprite>", "Another sprite file").parse(process.argv);
